...
import com.example.noteapp.utils.NoteBottomSheetFragment
...
class CreateNoteFragment : BaseFragment(), EasyPermissions.PermissionCallbacks,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        imgMore.setOnClickListener {
            ...
            noteBottomSheetFragment.show(requireActivity().supportFragmentManager,
    ...
    private fun updateNote() {
        launch {
            ...
            context?.let {
                ...
                notes?.let { it1 -> NotesDatabase.getDatabase(it)?.noteDao()?.updateNote(it1) }
                etNoteTitle.setText("")
    ...
    private fun hasReadStoragePerm(): Boolean {
        return EasyPermissions.hasPermissions(requireContext(), READ_EXTERNAL_STORAGE)
    }
